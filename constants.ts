...
const NEWS_DATA = [
  // --- FRONT PAGE ---
  {
    ...
    field: "Front Page",
    link: "#",
    description: "Toyota confirms mass production of solid-state batteries will begin in 2027, promising a 1,200km range and 10-minute charge times. The announcement has sent shockwaves through the EV supply chain.",
  ...
  {
    id: "fp-003",
    title: "F1 2026 Regulations: The Verdict",
    publisher: "F1 Journal",
    year: 2025,
    field: "Front Page",
    link: "#",
    description: "The FIA reveals the final chassis rules for 2026. Smaller, lighter cars with active aerodynamics are coming to save racing from the heavyweight era.",
  ...
  },
  {
    ...
    field: "Motorsport",
    link: "#",
    description: "After years of legal battles, Andretti Global will join the F1 grid as the 11th team in 2026, powered by GM.",
